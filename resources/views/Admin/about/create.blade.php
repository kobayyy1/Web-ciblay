        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-x-hidden">
            <main class="flex-1 p-6 md:p-8 space-y-6 overflow-y-auto">
                ...
                <div class="flex items-center gap-4 border-b border-gray-200 pb-4">
                    ...
                    <div>
                        <h2 class="text-2xl font-black text-[#0f2440] uppercase tracking-tight">Tambah Data About</h2>
                        <p class="text-xs text-gray-400">Tambahkan berkas profil pimpinan dan instansi baru ke sistem.</p>
                    </div>
                </div>
                ...
                <form action="{{ route('admin.about.store') }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-xs font-black uppercase text-[#0f2440] tracking-wider mb-2">Jabatan /
                                Gelar</label>
                            <input type="text" name="title" value="Ketua"
                                class="w-full border border-gray-200 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-[#ff9f1c]"
                                required>
                        </div>
                    </div>
                    ...
                    <div>
                        ...
                        <input type="file" name="image"
                            class="block w-full text-xs text-gray-500 mt-2 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-xs file:font-semibold file:bg-slate-100 file:text-slate-700 hover:file:bg-slate-200">
                    </div>
