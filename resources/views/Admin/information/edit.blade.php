    ...
    <div class="flex min-h-screen bg-gray-100 font-['Roboto']" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-x-hidden">
            <header
                ...
                <h2 class="text-xl font-black text-[#0f2440] uppercase tracking-tight">Edit Informasi</h2>
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 p-6 sm:p-8">
                    <form action="{{ route('admin.information.update', $information->id) }}" method="POST"
                        ...
                        <div class="flex flex-col text-left space-y-2">
                            <label class="text-xs font-black text-[#0f2440] uppercase tracking-widest">Judul
                                Informasi</label>
                        ...
                        <div class="flex flex-col text-left space-y-2">
                            ...
                            <input type="text" name="deskripsi_singkat"
                                value="{{ old('deskripsi_singkat', $information->deskripsi_singkat) }}"
                        ...
                        <div class="flex flex-col text-left space-y-2">
                            ...
                            <textarea name="deskripsi_lengkap" rows="6"
                                class="w-full p-4 rounded-xl border border-gray-200 focus:outline-none focus:border-[#0f2440] font-light text-sm leading-relaxed @error('deskripsi_lengkap') border-red-500 @enderror">{{ old('deskripsi_lengkap', $information->deskripsi_lengkap) }}</textarea>
