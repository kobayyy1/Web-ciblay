    ...
    <div class="flex min-h-screen bg-gray-100 font-['Roboto']" style="font-family: 'Roboto', sans-serif;">
        ...
        <div class="flex-1 flex flex-col min-w-0 overflow-x-hidden">
            <header
                ...
                <h2 class="text-xl font-black text-[#0f2440] uppercase tracking-tight">Kelola Informasi</h2>
            ...
            <main class="flex-1 p-6 md:p-8 space-y-8 overflow-y-auto">
                ...
                <div class="bg-white rounded-3xl shadow-sm border border-gray-100 overflow-hidden">
                    <div
                        ...
                        <div>
                            <h3 class="text-lg font-black text-[#0f2440] uppercase tracking-tight">Daftar Papan Informasi
                            </h3>
                            <p class="text-xs text-gray-400 font-normal">Kumpulan data pengumuman informasi yang tampil pada
                                halaman depan.</p>
                        </div>
                        ...
                        <table class="w-full text-left border-collapse">
                            <thead>
                                <tr
                                    ...
                                    <th class="py-4 px-6">Judul Informasi</th>
                                    ...
                                    <tr class="hover:bg-gray-50/80 transition-colors">
                                        <td class="py-4 px-6">
                                            <div
                                                ...
                                                <img src="{{ $info->image ? asset('storage/' . $info->image) : asset('images/berita1.png') }}"
                                        ...
                                        <td class="py-4 px-6">
                                            <div class="flex items-center justify-center gap-2">
                                                ...
                                                <form action="{{ route('admin.information.destroy', $info->id) }}"
                                                    method="POST"
                                                    onsubmit="return confirm('Yakin ingin menghapus data informasi ini, Jon?')"
                                                    class="inline-block">
                                                    @csrf
                                                    @method('DELETE')
                                                    <button type="submit"
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="py-12 text-center text-gray-400 italic font-medium">
                                            Belum ada data papan informasi di database, Jon.
                                        </td>
                                    </tr>
                                @endforelse
                            </tbody>
